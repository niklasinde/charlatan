...
class TestFixturesManager(testing.TestCase):
    ...
    def test_load_two_files(self):
        ...
        manager.load(
            './ciarlare/tests/data/simple.yaml')
        assert 'simple_dict' in manager.keys()

    def test_load_empty_file(self):
        """Verify we can load a emtpy file."""
        manager = FixturesManager()
        manager.load('./ciarlare/tests/data/empty.yaml')
    ...
    def test_get_all_fixtures(self):
        manager = FixturesManager()
        manager.load('./ciarlare/tests/data/simple.yaml')
    ...
    def test_dependency_parsing(self):
        fm = FixturesManager()
        fm.load(
            './ciarlare/tests/data/dependencies.yaml'
        )
    ...
    def test_notices_cyclic_dependencies(self):
        ...
        self.assertRaises(
            depgraph.HasACycle,
            fm.load,
            './ciarlare/tests/data/cyclic_dependencies.yaml'
        )
