...
htmlhelp_basename = 'charlatandoc'
...
latex_documents = [
    ('index', 'charlatan.tex', u'charlatan Documentation',
     u'Charles-Axel Dein', 'manual'),
]
...
man_pages = [
    ('index', 'charlatan', u'charlatan Documentation',
     [u'Charles-Axel Dein'], 1)
]
...
texinfo_documents = [
    ('index', 'charlatan', u'charlatan Documentation',
     u'Charles-Axel Dein', 'charlatan', 'One line description of project.',
     'Miscellaneous'),
]
